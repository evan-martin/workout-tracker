    ...
    return (
        <>
            ...
            {activity.map.summary_polyline !== "" &&
                <img src={`https://api.mapbox.com/styles/v1/mapbox/outdoors-v11/static/path-5+373dad-1(${encodeURIComponent(activity.map.summary_polyline)})/[${bounds._sw.lng},${bounds._sw.lat},${bounds._ne.lng},${bounds._ne.lat}]/300x150@2x?padding=30&access_token=${accessToken}`} alt={activity.name} />}
            {activity.map.summary_polyline === "" &&
